...
# for index, valor in enumerate(dataset["Gender"]):
#     if (valor == "m"):
#         dataset["Gender"][index] = pd.to_numeric(0)
#     else:
#         dataset["Gender"][index] = pd.to_numeric(1)
...
for i, desv in enumerate(desviaciones):
    print("Atributo " + dataset.columns[i] + " : " + str(desv))
